...
class SumberDayaKesehatanController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->sub_bidang = sub_bidang::where('bidang_id', 5)->get();
    }
    public function index()
    {
        return view('dashboard/sumberDayaKesehatan', [
    ...
    public function store(Request $request)
    {
        ...
        $user_action->bidang_id = 5;
        $user_action->user_id = $userId;
        $user_action->save();


        return redirect('dashboard/sumberDayaKesehatan')->with('berhasil', 'Berhasil Menambahkan Surat!');
    }
}
