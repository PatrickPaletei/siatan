...
class P2pController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->sub_bidang = sub_bidang::where('bidang_id', 3)->get();
    }
    ...
    public function store(Request $request)
    {
        ...
        $user_action->bidang_id = 3;
        $user_action->user_id = $userId;
        $user_action->save();
        return redirect('dashboard/pencegahanDanPengendalianPenyakit')->with('berhasil', 'Berhasil Menambahkan Surat!');
    }
}
